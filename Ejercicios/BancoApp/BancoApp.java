...
public class BancoApp {
    ...
    public static void main(String[] args) {
        ...
        cuenta2.aplicarTasa(cuenta2.getSaldo());
        
        // Mostramos los detalles de la cuenta
        cuenta2.mostrarDatosCuenta();
        
        // Creamos una cuenta coriente
        CuentaCorriente cuenta3 = new CuentaCorriente(3000, "27810", "Manuel Sanabria", "sanabria8@gmail.com", 2000.0);
        
        // Mostramos los detalles de la cuenta
        cuenta3.mostrarDatosCuenta();
        
        // Solicitamos un crédito
        cuenta3.solicitarCredito(2000);
    } // Main
} // Clase BancoApp
